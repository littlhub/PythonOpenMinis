  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'privacy',
        title: '隐私政策',
        subtitle: 'openminis.github.io · 原版',
        icon: '🖐️',
        tint: BLUE,
        kind: 'link',
      ...
      },
      {
        id: 'feedback',
        title: '反馈',
        subtitle: 'littlhub/PythonOpenMinis · 邮件',
        icon: '💬',
        tint: BLUE,
        kind: 'link',
        href: 'https://github.com/littlhub/PythonOpenMinis/issues/new',
      },
      {
        id: 'repo',
        title: '开源仓库',
        subtitle: 'littlhub/PythonOpenMinis',
        icon: '📦',
        tint: BLUE,
        kind: 'link',
        href: 'https://github.com/littlhub/PythonOpenMinis',
      },
    ],
  },
]
